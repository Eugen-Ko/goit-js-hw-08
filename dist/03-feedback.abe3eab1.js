...
},{"buffer":"../node_modules/buffer/index.js"}],"js/03-feedback.js":[function(require,module,exports) {
"use strict";
...
email.addEventListener('input', (0, _lodash.throttle)(onEmailInput, 500));
textArea.addEventListener('input', (0, _lodash.throttle)(onTextAreaInput, 500));
btn.addEventListener('click', (0, _lodash.throttle)(onBtnPress, 500)); // btn.addEventListener('submit', throttle(onBtn, 500));
